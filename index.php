...
$PAGE->set_url('/mod/videomission/index.php', ['id' => $id]);
$PAGE->set_pagelayout('incourse');
$PAGE->set_title(get_string('modulenameplural', 'mod_videomission'));
...
foreach ($instances as $instance) {
    ...
    $table->data[] = [html_writer::link($url, format_string($instance->name)),
        format_module_intro('videomission', $instance, $instance->coursemodule)];
}

echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('modulenameplural', 'mod_videomission'));
